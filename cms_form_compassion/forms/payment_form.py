...
if not testing:
    ...
    class PaymentForm(models.AbstractModel):
        ...
        acquirer_id = fields.Many2one(
            "payment.acquirer", "Selected acquirer", readonly=False
        )
        ...
        def _form_load_currency_id(self, fname, field, value, **req_values):
        ...
        def form_next_url(self, main_object=None):
            ...
            return "/compassion/payment/{}?redirect_url={}&display_type={}".format(
                str(self.transaction_id),
                self._payment_accept_redirect,
                self._display_type,
            )
        ...
        def form_after_create_or_update(self, values, extra_values):
            ...
            partner = (
                ...
                .sudo()
                .browse(all_vals.get("partner_id"))
                .exists()
            )
            tx_values = {
