...
class AccountStatementCompletionRule(Model):
    ...
    def _get_functions(self, cr, uid, context=None):
        ...
        res.append(('get_from_partner_ref', 'From line reference (based on the partner reference)'))
        res.append(('get_from_bvr_ref', 'From line reference (based on the BVR reference of the invoice)'))
        return res
