...
#   in the correspondence models. The original PDFs were storing the large templates
...
class CorrespondenceMigration(models.AbstractModel):
    ...
    @job(default_channel='root.sbc_compassion.migration')
    def migrate(self, correspondences_ids):
        ...
        _logger.warn(correspondences)
        _logger.warn(migrated)
        return True
