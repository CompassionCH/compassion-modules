...
class CompassionIntervention(models.Model):
    ...
    planned_end_date = fields.Date(readonly=True, track_visibility="onchange")
    ...
    commitment_amount = fields.Float(readonly=True, track_visibility="onchange")
    ...
    service_level = fields.Selection(
        ...
        required=True,
        readonly=True,
        states={"on_hold": [("readonly", False)], "sla": [("readonly", False)], },
    )
