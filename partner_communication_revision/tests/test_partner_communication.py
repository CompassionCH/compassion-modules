...
class TestPartnerCommunicationRevision(TransactionCase):
    def setUp(self):
        ...
        self.test_communication = self.env["partner.communication.config"].browse(
    ...
    def test_creating_keyword(self):
        ...
        html = '<span id="1-if-max_per_day" style="color: darkblue;">' "False</span>"
    ...
    def _load_communication_config(self, ref):
        return self.env["partner.communication.config"].browse(self.ref(ref))
