...
class Account_Banking_Mandate(orm.Model):
    ...
    def cancel(self, cr, uid, ids, context=None):
        ...
        for mandate in self.browse(cr, uid, ids, context=context):
            mail_thread_obj.message_post(
                cr, uid, mandate.partner_id.id, "For account: " +
                mandate.partner_bank_id.acc_number, "Mandate cancelled",
                'comment', context={'thread_model': mandate.partner_id._name})
    ...
    def back2draft(self, cr, uid, ids, context=None):
        ...
        for mandate in self.browse(cr, uid, ids, context=context):
            mail_thread_obj.message_post(
                cr, uid, mandate.partner_id.id, "For account: " +
                mandate.partner_bank_id.acc_number, "Mandate back to draft",
                'comment', context={'thread_model': mandate.partner_id._name})
    ...
    def unlink(self, cr, uid, ids, context):
        ...
        for mandate in self.browse(cr, uid, ids, context=context):
            mail_thread_obj.message_post(
                cr, uid, mandate.partner_id.id, "For account: " +
                mandate.partner_bank_id.acc_number, "Mandate deleted",
                'comment', context={'thread_model': mandate.partner_id._name})
