...
class FCPDisasterImpactMapping(OnrampMapping):
    ...
    CONNECT_MAPPING = {
        'Disaster_ImpactOnFCPProgram': 'impact_on_fcp_program',
        'FCPDisasterImpact_DisasterImpactDescription':
            'disaster_impact_description',
        'FCPDisasterImpact_FCPInfrastructureDisasterImpact': 'infrastructure',
        'FCP_ID': ('project_id.fcp_id', 'compassion.project'),
        # Not used in Odoo (related fields)
        'FCP_Name': None,
        'Disaster_Name': None,
        'FCPDisasterImpact_FCPDisasterStatus': None,
    }
...
class FieldOfficeDisasterMapping(OnrampMapping):
    ...
    CONNECT_MAPPING = {
        ...
        'ImpactOnFCPInfrastructureDamaged':
            'impact_on_fcp_infrastructure_damaged',
        'ImpactOnFCPInfrastructureDestroyed':
            'impact_on_fcp_infrastructure_destroyed',
        'ImpactOnFCPProgramTemporarilyClosed':
        ...
        'ReportedNumberOfFCPsImpacted': 'reported_number_of_fcps_impacted',
        ...
        'FCPDisasterImpacts': ('fcp_disaster_impact_ids',
                               'fcp.disaster.impact'),
