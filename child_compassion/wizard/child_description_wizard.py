...
class child_description_wizard(orm.TransientModel):
    ...
    #                  generation                    #
    ##################################################
    def gen_de_translation(self, cr, uid, child, case_study, context=None):
        desc_de = self._get_guardians_info_de(cr, uid, child, case_study, context)
        desc_de += self._get_school_info_de(cr, uid, child, case_study, context)
        desc_de += self._gen_christ_act_de(cr, uid, child, case_study, context)
        desc_de += self._gen_family_act_info_de(cr, uid, child, case_study, context)
        desc_de += self._gen_hobbies_info_de(cr, uid, child, case_study, context)
        return desc_de
