...
class TestCommunicationJob(TransactionCase):
    ...
    def assert_utf8_equal(self, actual, expected):
    ...
    def test_call(self):
        self.assertEqual(self.partner.global_communication_delivery_preference,
                         'auto_digital')
        ...
        self.assert_utf8_equal(call_answer['context']['phone_number'],
                               u'+32\xa010\xa058\xa085\xa058')
        self.assert_utf8_equal(call_answer['context']['call_name'],
    ...
    def test_config(self):
        ...
        self.partner.global_communication_delivery_preference = 'none'
        self.assertEqual(self.config.get_inform_mode(self.partner), (False,
                                                                     False))
